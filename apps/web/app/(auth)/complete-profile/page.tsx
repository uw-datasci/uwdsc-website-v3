...
export default function CompleteProfilePage() {
  ...
  return (
    <div className="bg-black w-full min-h-screen flex flex-col items-center justify-center px-12 py-8 overflow-hidden">
      ...
      <div className="flex-1 flex items-center justify-center w-full relative min-h-[min(70vh,560px)]">
        <AnimatePresence mode="wait">
          {isProfileComplete ? (
            <motion.div
              ...
              className="w-full flex flex-col items-center justify-center absolute inset-0"
            >
