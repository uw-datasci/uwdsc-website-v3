...
/**
 * Demo route for the gacha reveal modal, so reviewers can exercise the
 * component inside the real app shell without a live event or login.
 * Remove (or gate) once the check-in flow ships.
 */
