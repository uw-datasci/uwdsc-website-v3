  ...
  return (
    <NavigationMenuItem className="relative mr-2 pl-8 before:absolute before:left-0 before:top-1/2 before:h-10 before:w-px before:-translate-y-1/2 before:bg-white/35">
      ...
      <NavigationMenuContent className="bg-transparent! border-0! shadow-none! mt-5! w-max">
        ...
        >
          <div className={group.adminLink ? "flex gap-1 p-2" : "p-2"}>
            {group.adminLink ? <AdminLink item={group.adminLink} /> : null}
            <ul
              className={
                group.adminLink ? "flex min-w-44 flex-1 flex-col gap-1" : "grid w-44 gap-1"
              }
            >
