      ...
      <div className="relative z-10 flex h-full flex-col px-2 pt-14 pb-2">
        <div aria-hidden="true" className="pointer-events-none absolute inset-x-0 top-0 h-[38%] overflow-visible">
          {topPatterns.map((pattern, index) => {
            const Svg = [
              (
                <svg viewBox="0 0 187 228" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              (
                <svg viewBox="0 0 191 221" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              (
                <svg viewBox="0 0 204 191" fill="none" xmlns="http://www.w3.org/2000/svg">
