  ...
  return (
    ...
    >
      <div className="relative z-10 flex h-full flex-col px-2 pt-14 pb-2">
        <div
          aria-hidden="true"
          className="pointer-events-none absolute inset-x-0 top-0 h-[38%] overflow-visible"
        >
          {topPatterns.map((pattern, index) => {
            const Svg = [
              ...
              >
                <path
                  d="M114.786 0.014414C140.888 -0.502439 161.104 12.8783 162.136 40.5177C174.992 39.8367 187.29 40.5668 197.214 49.6077C207.212 58.7141 203.531 72.4066 195.181 80.9716C179.045 97.5109 157.609 102.015 135.362 102.77C141.412 125.626 152.584 145.193 153.58 170.42C156.174 195.574 126.356 197.789 128.167 171.979C129.177 157.605 124.907 145.964 120.619 132.476C118.638 125.511 116.917 119.588 114.448 112.746C97.3553 131.336 43.2128 175.129 27.1536 128.9C23.7112 118.989 28.6266 106.667 33.9031 97.954C23.0892 96.0917 11.6081 86.8868 5.48479 77.9526C-5.07554 62.5372 0.295321 44.4555 15.7587 35.0373C30.6272 25.9801 46.6446 28.4578 62.611 32.2234C72.7717 11.8036 93.5543 3.29602 114.786 0.014414Z"
                  fill="#2dd4bf"
                />
                <path
                  d="M113.481 24.5171C124.101 23.8279 128.46 26.1168 135.532 33.3774C136.483 37.4958 136.908 42.1885 137.412 46.4382C130.382 52.2384 127.859 61.148 136.302 67.178C145.319 73.6181 165.804 66.2017 177.429 64.6347C163.811 72.2645 158.645 75.1933 142.781 77.3099C137.532 79.525 116.723 71.0748 114.087 73.9134C95.9072 93.48 87.8768 107.788 63.0233 121.316C59.2214 123.359 54.9017 125.886 51.4552 122.539C49.974 117.173 52.8363 111.381 54.7647 106.032C106.676 73.733 24.9957 80.8787 24.5312 60.4999C26.1872 57.0296 27.501 55.8564 31.0723 54.1664C47.6591 46.2988 58.7922 59.0396 73.719 64.2984L74.6947 64.6347C85.9057 59.4252 92.386 53.871 82.7431 42.73C93.0868 30.8834 97.9948 28.2253 113.481 24.5171Z"
                  fill="#ff8fab"
                />
              </svg>,
              <svg
        ...
        <ol className="mt-8 flex flex-1 flex-col gap-4">
          ...
          {slide.events.map((event, i) => (
            <motion.li
              key={event.id}
              variants={slideItem}
              className="grid grid-cols-[3rem_3.25rem_minmax(0,1fr)] items-center gap-3"
            >
              <span
                className={cn(
                  display,
