...
export function PasswordResetsSlide({ slide }: PasswordResetsSlideProps) {
  const pileOrnaments: {
    ...
    { kind: "leaf", left: "-4%", bottom: "-12%", width: "5.5rem", rotate: "-14deg" },
    { kind: "mushroom", left: "14%", bottom: "-18%", width: "6.5rem", rotate: "10deg" },
    { kind: "flower", left: "34%", bottom: "-10%", width: "5.5rem", rotate: "-6deg" },
    { kind: "flower", left: "52%", bottom: "-16%", width: "6rem", rotate: "14deg" },
    { kind: "mushroom", left: "70%", bottom: "-10%", width: "6rem", rotate: "-8deg" },
    { kind: "leaf", right: "-4%", bottom: "-14%", width: "5.5rem", rotate: "12deg" },
  ];

  const PILE_BLOBS = { mushroom: MushroomBlob, flower: FlowerBlob, leaf: LeafBlob };
  ...
  return (
    ...
    >
      <div aria-hidden="true" className="pointer-events-none absolute inset-x-0 bottom-0 z-0 h-[38%] overflow-visible">
