...
import { Floating, motion, slideItem, slideStagger } from "../motion";
  ...
  return (
    ...
    >
      <div className="relative z-10 flex h-full min-h-0 w-full max-w-104 flex-col items-center justify-center gap-4 pt-6 pb-2 sm:max-w-96 sm:gap-6 sm:pt-10 sm:pb-2">
        ...
        <motion.div variants={slideItem} className="relative flex items-center justify-center">
          <Floating amplitude={5} duration={4.5}>
