...
const SOCIAL_LINKS = [
  ...
  { label: "LinkedIn", href: "https://www.linkedin.com/company/waterloo-data-science-club/" },
          ...
          <Section>
            ...
            {type === "offer" ? (
              <>
                ...
                <Text style={{ ...bodyTextStyle, marginBottom: "4px", fontWeight: 700 }}>
                  Co-Presidents
                </Text>
              ...
              <>
                ...
                >
                  ...
                  <Link href="https://uwdsc.ca" style={{ ...linkStyle, color: "#6b7280" }}>
                    uwdsc.ca
                  </Link>
                </Text>
              </>
